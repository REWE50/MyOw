...
<li>The MyOw Server displays the information to the Pet Owner</li>
                            ...
                            <p>7.a If the Pet Owner clicks on the Vet suggested by the AI Server                            </p>
                            <ol>
                           	  <li>The Pet Owner may contact the Vet by phone</li>
                                <li>The Pet Owner may contact the Vet by email </li>
                                <li>The Pet Owner may ask for direction through the Google Maps API</li>
                            </ol>
            ...
            <div class="row">
                ...
                <h2>Use Case Flow Diagram</h2><br>
                	<img src="images/find-vet-practice-flow.png" alt="UC2 - Flow Diagram" class="img-responsive">
            	</div>
            </div>           
